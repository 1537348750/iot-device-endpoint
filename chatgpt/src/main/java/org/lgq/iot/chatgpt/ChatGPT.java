...
import org.lgq.iot.chatgpt.entity.BaseResponse;
import org.lgq.iot.chatgpt.entity.billing.CreditGrantsResponse;
import org.lgq.iot.chatgpt.entity.chat.ChatCompletion;
import org.lgq.iot.chatgpt.entity.chat.ChatCompletionResponse;
import org.lgq.iot.chatgpt.entity.chat.Message;
import org.lgq.iot.chatgpt.exception.ChatGptException;
        ...
        client.addInterceptor(chain -> {
            ...
            if (!response.isSuccessful()) {
                ...
                if (Objects.nonNull(baseResponse.getError())) {
                    ...
                    throw new ChatGptException(baseResponse.getError().getMessage());
                }
                throw new ChatGptException("error");
            }
            return response;
        });
